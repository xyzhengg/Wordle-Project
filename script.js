...
function checkGuess() {
    if (guess.toLowerCase() === "xinyu" && !wordList.includes("xinyu")) {
        ...
        document.querySelector('.notRealWord').innerText = "That's not a valid word!"
    } else if (wordList.includes(guess.toLowerCase())) {
